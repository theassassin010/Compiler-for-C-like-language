...
public:
	...
	virtual int get_num();
	virtual Symbol_Table_Entry & get_symbol_entry_opd();
};
...
public:
	...
	Symbol_Table_Entry & get_symbol_entry_opd();
};
...
public:
	Compute_IC_Stmt(Tgt_Op inst_op, Ics_Opd * result, Ics_Opd * opd1, Ics_Opd * opd2); 
	~Compute_IC_Stmt() {} 
...
public:
	Control_Flow_IC_Stmt(Tgt_Op inst_op, Ics_Opd * opd1, Ics_Opd * opd2, string label); 
	Control_Flow_IC_Stmt(Tgt_Op op, string label);
...
public:
	Label_IC_Stmt(Tgt_Op inst_op, Ics_Opd * opd1, string label); 
	~Label_IC_Stmt() {} 
...
class Return_IC_Stmt: public Icode_Stmt
{
 ...
 public:
	Return_IC_Stmt();
	Return_IC_Stmt(Tgt_Op inst_op, Ics_Opd * res, Ics_Opd * opd_temp, int temp_offset);
	~Return_IC_Stmt();
