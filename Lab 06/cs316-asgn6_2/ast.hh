...
class Print_String_Ast: public Ast{
	string str;
	int val;
public:
	Print_String_Ast(string s, int line);
	~Print_String_Ast();
...
class Print_Variable_Ast: public Ast{
	Ast* var;
	int val;
public:
	Print_Variable_Ast(Ast* temp, int line);
	~Print_Variable_Ast();
...
public:
	Function_Ast();
	Function_Ast(Procedure *proc);
	Function_Ast(Procedure *proc, list<Ast *> arg_list);
	~Function_Ast();
...
class Return_Ast: public Ast{
	Ast *retrn;
	// int line; already in Ast int lineno;

public:
	Return_Ast(int line);
	Return_Ast(Ast *retrn, int line);
	~Return_Ast();
