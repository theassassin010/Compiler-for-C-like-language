...
void Sequence_Ast::print_assembly(ostream & file_buffer){
	list<Icode_Stmt *>::iterator iter = sa_icode_list.begin();
	while(iter != sa_icode_list.end()){
		(*iter)->print_assembly(file_buffer);
		iter++;
	}
}
...
Code_For_Ast & Print_String_Ast::compile(){

}

//////////////////////////////////////////////////////////////////////////////

Code_For_Ast & Print_Variable_Ast::compile(){

}

//////////////////////////////////////////////////////////////////////////////

Code_For_Ast & Function_Ast::compile(){
