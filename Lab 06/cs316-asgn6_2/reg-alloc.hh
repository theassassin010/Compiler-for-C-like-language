...
class Register_Descriptor
{
  ...
  public:
    ...
    bool is_free();
    Register_Val_Type get_value_type(); //returns the data type of the value
};
...
public:
	...
	Register_Descriptor * get_return_int_register();
	Register_Descriptor * get_return_float_register();
};
